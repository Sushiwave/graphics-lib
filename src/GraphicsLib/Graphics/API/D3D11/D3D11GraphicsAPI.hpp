...
namespace cg
{
	namespace d3d11
	{
		...
		public:
			...
			[[nodiscard]] std::shared_ptr<IMultipleRenderTargets> createMultipleRenderTargets(const std::vector<std::shared_ptr<IRenderTarget>>& renderTargetList) override;
			...
			[[nodiscrad]] std::shared_ptr<IMultipleRenderTargets> createMultipleRenderTargets(const cpp::Vector2D<int>& size, const std::vector<TextureFormat> renderTargetFormatList, int sampleCount = 1) override;
