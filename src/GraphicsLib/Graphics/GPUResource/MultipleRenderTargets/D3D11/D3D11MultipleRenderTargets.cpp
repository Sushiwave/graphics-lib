...
namespace cg
{
	namespace d3d11
	{
		MultipleRenderTargets::MultipleRenderTargets(const std::vector<std::shared_ptr<IRenderTarget>>& renderTargetList)
			: cg::MultipleRenderTargets([&](int count, std::shared_ptr<IDepthStencilBuffer> depthStencilBuffer)
			  {
		...
		MultipleRenderTargets& MultipleRenderTargets::operator=(const MultipleRenderTargets& other)
		{
